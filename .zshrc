...
plugins=(git python history history-substring-search git-flow svn django ssh-agent mvn scala autojump autoenv compleat urltools rvm npm vagrant go pip brew bower fabric docker gem redis-cli rsync sbt screen sudo tmux colored-man)
# virtualenvwrapper 
