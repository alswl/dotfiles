...
addSearchAlias('w', 'wiki', 'https://wiki.duitang.net/dosearchsite.action?queryString=');
addSearchAlias('idc', 'idc', 'http://idc.duitang.net/?page=search&last_page=index&last_tab=default&q=');
